...
#filter_img = cv2.inRange(img, (0, 0, 0), (200, 150, 255))

# 경계선 가져오기
contours_simple = get_contours(thr, 50, True)
contours_none = get_contours(thr, 50, False)
